...
export default function Page () {
    ...
    const [tab, setTab] = useState<"home" | "portfolio" | "blog" | "store" >("home");
            ...
            <Navbar/>
            {
                ...
                <div className="pt-3 pl-3 flex flex-row">
                    <ul className="menu menu-horizontal bg-base-200 rounded-box sticky top-3">
                        <li>
                            <a className="tooltip tooltip-right" data-tip="Home" onClick={() => setTab("home")}>
                                <span className="material-symbols-outlined">home</span>                        
                            </a>
                        </li>
                        <li>
                            <a className="tooltip tooltip-right" data-tip="Portfolio Posts" onClick={() => setTab("portfolio")}>
                                <span className="material-symbols-outlined">photo_library</span>                        
                            </a>
                        </li>
                        <li>
                            <a className="tooltip tooltip-right" data-tip="Blog Posts" onClick={() => setTab("blog")}>
                                <span className="material-symbols-outlined">contextual_token</span>
                            </a>
                        </li>
                        <li>
                            <a className="tooltip tooltip-right" data-tip="Marketplace" onClick={() => setTab("store")}>
